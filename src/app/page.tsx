...
export const metadata: Metadata = {
  ...
  description:
    "Free online tools for developers and creators. JSON formatter, regex tester, Base64 encoder, word counter, and 36+ more utilities. 100% client-side, no signup required.",
  alternates: { canonical: "https://www.devpik.com" },
  openGraph: {
    title: "DevPik - Free Online Developer Tools, Text Utilities & Tech Blog",
    description:
      "Free online tools for developers and creators. JSON formatter, regex tester, Base64 encoder, word counter, and 36+ more utilities. 100% client-side.",
...
const STATS = [
  { value: "36+", label: "Free Tools", icon: Wrench },
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <p className="mt-4 max-w-xl text-base md:text-lg leading-relaxed text-muted-foreground opacity-0 animate-fade-in-up stagger-2">
                Explore 36+ free online tools for text processing, code formatting, network testing,
                  ...
                  <div className="p-5 space-y-3.5">
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-1">
                      <div className="rounded-lg bg-white/5 border border-white/10 p-2.5 text-center">
                        <div className="text-lg font-bold text-cyan-400">36+</div>
