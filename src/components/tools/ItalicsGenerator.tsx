...
const STYLES: StyleDef[] = [
    {
        ...
        preview: "𝘐𝘵𝘢𝘭𝘪𝘤",
        map: (() => {
            const m = buildMap(0x1D608, 0x1D622);
            return m;
        })(),
    },
    {
    ...
    {
        label: "Bold Fraktur",
        preview: "𝕭𝖔𝖑𝖉 𝕱𝖗𝖆𝖐𝖙𝖚𝖗",
        map: buildMap(0x1D56C, 0x1D586),
    },
    {
        label: "Double-Struck",
        preview: "𝔻𝕠𝕦𝕓𝕝𝕖",
...
export default function ItalicsGenerator() {
    ...
    const handleInput = (val: string) => {
        ...
        if (!tracked.current && val.trim()) {
            trackToolUsage("italics-generator");
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col rounded-xl border border-border bg-card overflow-hidden shadow-sm">
                ...
                <textarea
                    ...
                    placeholder="Type or paste your text here to generate italic and fancy text styles..."
            ...
            {text.trim() ? (
                ...
                <div className="flex items-center justify-center h-40 rounded-xl border border-dashed border-border text-sm text-muted-foreground">
                    Start typing above to see your text in 12 different italic and fancy styles
                </div>
            )}
